...
const Button = ({baseColor, mainText, textColor, paddingHorizontal, paddingVertical, fontSize, fontWeight}) => {
    const calcFontColor = () => {
    ...
    return (
        <button className={"genericButton"} style={dynamicStyles} role={"button"}>{mainText}</button>
    );
  };
